...
CREATE Wed-condition Contrata as Pagamentos_status = pago;
...
CREATE Wed-trigger E (Usuário_Titular_Removido,Remover_Usuário);

CREATE Wed-trigger F (Usuário_Titular_Removido,Remover_Conta);
